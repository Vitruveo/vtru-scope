        ...
        if (!processing) {
          ...
          provider.getBlockNumber().then((block) => { 
            ...
            readContract({
              ...
              const vtruPrice = Number((usdcVtruReserve * BigInt(Math.pow(10, 18)) / wVTRUReserve)) / Math.pow(10, 6);
            ...
            readContract({
              ...
              args: []
                ...
                const vtroPrice = Number((usdcVtroReserve * BigInt(Math.pow(10, 18)) / vtroReserve)) / Math.pow(10, 6);
