...
const StakeInputForm = (props:any) => {
  ...
  const vibeLabelStyle = {color: '#0FFF50', fontSize: '16px', display: 'inline', lineHeight: '40px', marginLeft: '10px'};  const ratioStyle = {marginLeft: '40px'};
