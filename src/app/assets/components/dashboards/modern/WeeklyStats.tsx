  ...
  const seriescolumnchart = [
    {
      name: "Top Sales",
      color: primary,
      data: createChartData({ value: slidersValues.topSales }),
    },
    {
      name: "Best Seller",
      color: secondary,
      data: createChartData({ value: slidersValues.bestSeller }),
    },
    {
      name: "Most Commented",
      color: error,
      data: createChartData({ value: slidersValues.mostCommented }),
    },
  ];
